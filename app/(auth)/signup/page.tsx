          ...
          {isSignedUp ? (
            <CardContent className="py-12 text-center space-y-6">
              <motion.div
                ...
                className="w-20 h-20 bg-accent-teal/10 rounded-full mx-auto flex items-center justify-center border-2 border-accent-teal/20"
              >
                <Mail className="text-accent-teal w-10 h-10" />
              </motion.div>
              <div className="space-y-2">
                <h2 className="text-2xl font-bold text-text-primary">Check Your Email</h2>
                <p className="text-text-secondary">
                  We've sent a verification link to <span className="text-accent-purple font-bold">{email}</span>. 
                  Please click the link to confirm your account and start your journey.
                </p>
              </div>
              <div className="pt-4">
                <Link href="/login">
                  <Button variant="primary" className="btn-aurora px-8">
                    Go to Login
                  </Button>
                </Link>
              </div>
